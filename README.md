...
ends with `#`; stop if it does not. Then download the Beta 8 archive and its
...
pkg="/tmp/allscan-reimagined-1.0.0-beta.8.tar.gz"
checksum="${pkg}.sha256"
stage="$(mktemp -d /tmp/asr-beta-8-install.XXXXXX)"
base="https://github.com/ke7wil-bridge/allscan-reimagined/releases/download/v1.0.0-beta.8"
...
tar -xzf "$pkg" -C "$stage"
cd "$stage/allscan-reimagined-1.0.0-beta.8"
